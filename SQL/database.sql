...
CREATE TABLE AE_ALLOWED(
	...
	USER_AID NUMBER(10) NOT NULL,
	CHANNEL_AID NUMBER(10) NOT NULL,
	CONSTRAINT ALLOWED_USERS FOREIGN KEY (USER_AID) REFERENCES AE_USERS (AEID) ON DELETE CASCADE,
	CONSTRAINT ALLOWED_CHANNELS FOREIGN KEY (CHANNEL_AID) REFERENCES AE_CHANNELS (CHANNELID) ON DELETE CASCADE
);
